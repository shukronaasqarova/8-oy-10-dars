...
function Home() {
    ...
    return (
        <div className='relative'>
            <div className="fixed-timeline">
                ...
                <div className="timeline-numbers">
                    {['01', '02', '03'].map((num, index) => (
                        <div
                            key={num}
                            className={`timeline-number ${activeSection === index ? 'active' : ''}`}
                            onClick={() => {
                                const sections = document.querySelectorAll('.section');
            ...
            <div className="section bg-[url('/bg.jpg')] bg-cover bg-center h-[1500px] w-full mt-0">
                <header className='flex items-center justify-around'>
                    ...
                    <nav className='flex items-center gap-5 mt-7'>
                        ...
                        <h4 className='font-bold text-lg text-white'>Blog</h4>
                    </nav>
                    <div className='flex items-center gap-2 mt-7 text-white'>
                        <FaUser />
            ...
            <div className='bg-[#060723] p-10 mx-auto flex justify-center'>
                <div>
                    <div>
                        <div className='section flex items-center gap-[264px] relative mb-[200px]'>
                            <div>
                        ...
                        <div className='section flex items-center gap-[264px] relative'>
                            <div>
                        ...
                        <div className='section flex items-center gap-[264px] relative mt-[200px]'>
                            <div>
                                <div className='flex items-center gap-2 text-[#FBD784] mb-7'>
                                    <MdOutlineHorizontalRule />
